...
public class Artwork {
	...
	public String toString() {
		return "ArtworkList [id=" + id + ", title=" + title + ", artistName=" + artistName + ", media=" + media
				+ ", year=" + year + ", value=" + value + "]";
	}
	public String returnItemDetails() {
		DecimalFormat df = new DecimalFormat("$##0.00");
		return "Artist, " + artistName + " created " + title + ". It is a " + media + " piece created in " + year + " costing " + df.format(value);
	}
}
